...
<div class="min-h-screen flex flex-col bg-background text-foreground px-6 py-4">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex items-center gap-4">
            <button class="hover:underline text-sm" title="Click to view dashboard" on:click={() => goto('/Team_3/dashboard')}>
                Dashboard
            </button>
            <button class="hover:underline text-sm" title="Click to access settings" on:click={() => goto('/Team_3/settings')}>
                Settings
            </button>
            <button
